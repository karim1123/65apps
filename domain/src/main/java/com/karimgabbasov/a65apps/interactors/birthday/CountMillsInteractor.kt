...
object CountMillsInteractor : CountMillsUntilBirthdayInteractor, IsLeapYearInteractor {
    override fun String?.countMills(): Long {
    ...
    override fun Int.isLeapYear(): Boolean {
        var leap = false
        if (this % 4 == 0) {
            if (this % 100 == 0) {
                leap = this % 400 == 0
