...
import com.karimgabbasov.a65apps.interactors.viewmodel.ContactDataSourceInteractor
...
class ContactsDataSource(private val context: Context) : ContactDataSourceInteractor {
    ...
    override fun getContactListData(query: String): List<ContactsListModel> {
        val contactList = mutableListOf<ContactsListModel>()
